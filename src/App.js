...
class App extends Component {
  ...
  handleList( e ) {
    ...
    let endPoint = `https://thingproxy.freeboard.io/fetch/https://openapi.etsy.com/v2/listings/active?tags=${ this.state.tag }&limit=50&includes=Images:1&api_key=${ API_KEY }`
    fetch( endPoint )
