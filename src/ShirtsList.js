...
class ShirtsList extends Component {
    ...
    componentDidMount() {
        let endPoint = `https://thingproxy.freeboard.io/fetch/https://openapi.etsy.com/v2/listings/active?tags=shirts&limit=50&includes=Images:1&api_key=nszdmo8kz1ia6wmqt2t4ag6c`
        fetch( endPoint )
